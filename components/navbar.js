        ...
        <ul className="mb-4 mt-2 text-center flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            <Link href="/" className="flex items-center">
                <Typography
                    ...
                    className={
                        router.pathname == '/'
                            ? 'cursor-pointer px-2 py-1 font-semibold text-white border-primary bg-primary rounded-md	border-4'
                            : 'cursor-pointer p-1 font-semibold text-[#0797B7]'
                    }
